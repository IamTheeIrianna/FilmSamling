...
//
//        //Arrange
//        model.MovieCollection movieCollection = new model.MovieCollection(movieCollection.getMovieCollectionList());
//
//        //Act
//        movieCollection.addMovie("Batman", "Chris Nolan", 2007, true, 120, "action");
//        movieCollection.addMovie("John", "Peter", 2010, true, 120, "comedy");
//
//        ArrayList<model.Movie> movies = movieCollection.getMovieCollectionList();
